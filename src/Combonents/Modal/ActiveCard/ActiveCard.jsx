...
import VisuallyHiddenInput from '~/Combonents/Form/VisuallyHiddenInput'
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              {/* nếu user hiện tại đang loggin chưa thuộc mảng memberIds của card mà muốn join vào card thì ấn vào nút join(hiện nút join có thể ấn, ngược lại thì không) */}
              {!activeCard?.memberIds?.includes(currentUser._id) &&
                <SidebarItem className="active" onClick={() => onUpdateCardMember({ userId: currentUser._id, action: CARD_MEMBER_ACTION.ADD })}>
