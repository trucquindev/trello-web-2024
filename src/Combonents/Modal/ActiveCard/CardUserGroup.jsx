...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMember }) {
  ...
  // Lấy dữ liệu của bảng board để lấy danh sách user và thong tin chi tiet thành viên của card thong qua FE_allUsers
  ...
  const handleUpdateCardMembers = (user) => {
    ...
    // tạo 1 biến incomingMemberInfor để gửi cho BE -> chứa 2 thông tin chính là userId và action (action là trạng thái xóa khỏi card(REMOVE) hay thêm vào card(ADD))
